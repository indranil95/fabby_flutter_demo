/// data : {"user_cart_product_count":1}
/// success : true
/// error : 200
/// status_code : "Success Removed From Cart"
library;

class RemoveSingleItemModel {
  RemoveSingleItemModel({
      Data? data, 
      bool? success, 
      num? error, 
      String? statusCode,}){
  ...
  RemoveSingleItemModel.fromJson(dynamic json) {
  ...
  num? _error;
  String? _statusCode;
RemoveSingleItemModel copyWith({  Data? data,
  bool? success,
  num? error,
  String? statusCode,
}) => RemoveSingleItemModel(  data: data ?? _data,
