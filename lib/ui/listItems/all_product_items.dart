...
class AllProductItems extends StatelessWidget {
  ...
  final String price;
  final VoidCallback onMoveToProductDetail;
  ...
  const AllProductItems({
    ...
    required this.price,
    required this.onMoveToProductDetail,
  });
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        width: 160.0,
        // Adjust the width to match your desired size
        height: 250.0,
          ...
          children: [
            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  color:
                      const Color(0xFFF8EDE8), // Background color for the card
                  borderRadius: BorderRadius.circular(15.0),
                ),
                child: Column(
                  children: [
