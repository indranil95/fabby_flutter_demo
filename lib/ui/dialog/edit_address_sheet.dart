...
class _EditAddressSheetState extends State<EditAddressSheet> {
  // Flag to check if the data is already initialized
  ...
  Future<void> _fetchCustomerAddress() async {
    final requestBody = {
      'id': widget.id, // Handle the case where guestId is null
    };

    viewModel.getCustomerAddress(requestBody);
  }
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Consumer<MemberCheckoutViewModel>(
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (_firstNameController.text.isNotEmpty &&
                        ...
                        LoggerService.i("inState", "if first");
                        final requestBody = {
                          'id': widget.id,
                        ...
                        if (_emailAddressController.text.isEmpty) {
                          LoggerService.i(
                              "inState", "_emailController.text.isEmpty");
                          _emailAddressError = AppStrings.thisFieldIsRequired;
                          _showEmailAddressError = true;
                          ...
                          _emailAddressError =
                              AppStrings.pleaseProvideValidEmail;
                          _showEmailAddressError = true;
                        } else {
                          _emailAddressError = "";
                          _showEmailAddressError = true;
                        ...
                        if (_phoneNumberController.text.isEmpty) {
                          LoggerService.i(
                              "inState", "_phoneController.text.isEmpty");
                          _phoneNumberError = AppStrings.thisFieldIsRequired;
                          _showPhoneNumberError = true;
                          ...
                          _phoneNumberError =
                              AppStrings.pleaseProvideValidPhone;
                          _showPhoneNumberError = true;
                        } else {
                          _phoneNumberError = "";
                          _showPhoneNumberError = false;
                        ...
                        if (_addressLine1Controller.text.isEmpty) {
                          LoggerService.i("inState", "_showMessageError");
                          _addressLine1Error = AppStrings.thisFieldIsRequired;
                          _showAddressLine1Error = true;
                        } else {
                          _addressLine1Error = "";
